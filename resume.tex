...
\name{Nimai Patel}
	...
	\hspace{1cm}Website: \href{https://nimaipatel.me}{nimaipatel.me}
...
\begin{resume_section}{Skills}
	...
	\begin{resume_subsection}{Programming Languages}
		\begin{subitems}
			\item C, C++, Bash and POSIX compilant shell script, Python, JavaScript, Haskell, Lua
		\end{subitems}
	\end{resume_subsection}

	\begin{resume_subsection}{Tools}
		\begin{subitems}
		\item Git, UNIX and GNU core utilities, Vim, {\LaTeX}
		\end{subitems}
	\end{resume_subsection}

	\begin{resume_subsection}{Web Development Stacks}
		\begin{subitems}
		\item React, Node.js, MongoDB, PostgreSQL, WebSockets, RESTFful APIs
		\end{subitems}
	\end{resume_subsection}
