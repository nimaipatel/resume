...
\begin{resume_section}{Education}
	...
	\begin{resume_subsection}[2023 - 2025]{The Pennsylvania State University}
		\begin{subitems}
		\item Master of Science in Computer Science and Engineering
		\end{subitems}
	\end{resume_subsection}

	\begin{resume_subsection}[2019 - 2023]{D.J. Sanghvi College of Engineering}
		\begin{subitems}
		\item B.Tech IT Engineering CGPA \textbf{9.22/10}
		\end{subitems}
	\end{resume_subsection}
...
\begin{resume_section}{Experience}
	...
	\begin{resume_subsection}[Since July 2022]{BAS and SOC project Intern at TASL}
		\begin{subitems}
	...
	\begin{resume_subsection}[Since August 2023]{Learning Assistant CMPSC 311 -- Introduction to Systems Programming}
		\begin{subitems}
